...
const sampleGroups = [
  ...
  { icon: "keyboard", title: "Instrument patches", meta: "240 presets", description: "Original bass, lead, keys, pluck, pad, bell, vocal, motion and experimental synthesizer starting points." },
];
      ...
      <section className="site-section site-section--tight">
        <div className="site-container">
          <div className="sound-summary-card">
            <div><span>Factory WAV assets</span><strong>444</strong><small>Approximately 154.4 MiB of local source audio</small></div>
            <div><span>Editable synth patches</span><strong>240</strong><small>Twenty categories with full parameter access</small></div>
        ...
        <div className="site-container">
          ...
          <div className="library-browser-demo">
            <div className="library-browser-demo__sidebar">
              {['All sounds','808','Kicks','Snares','Claps','Closed hats','Open hats','Loops','Textures','Transitions'].map((name,index) => <button key={name} className={index === 1 ? 'is-active' : ''}>{name}<span>{[444,48,40,32,28,32,20,64,32,48][index]}</span></button>)}
            </div>
