...
assert(state.project.version === 7.5, "Project schema version must be 7.5.");
...
const stressStats = finalizeRenderedBuffer(mockBuffer, { ceilingDb: -1, lookAheadMs: 6, releaseMs: 140 });
