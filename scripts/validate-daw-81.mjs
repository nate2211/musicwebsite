...
assert(engine.includes("renderWithOptions" ) || elementaryRealtimeSource.includes("renderWithOptions"), "Click-free Elementary root graph transitions are missing.");
...
assert(state.project.version === 8.1, "Project schema version must be 8.1.");
