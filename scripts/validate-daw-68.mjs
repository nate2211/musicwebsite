...
assert(state.project.version === 6.8, "Project schema version must be 6.8.");
...
if (errors.length) {
  console.error("DAW 6.8 validation failed:");
  errors.forEach((error) => console.error(` - ${error}`));
  process.exit(1);
}

console.log("DAW 6.8 validation passed: direct synth-track creation, multi-track selection, selective/all mute controls, selected/all delete controls, 240 layered enterprise presets, dual spectral layers, procedural texture beds, and all DAW 6.7 piano-roll workflows.");
