...
assert(state.project.version === 8.7, "Project schema version must be 8.7.");
...
assert(engine.includes('this.streamBackend = "Direct native Web Audio"'), "Direct native output is not the default realtime route.");
