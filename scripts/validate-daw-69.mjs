...
assert(state.project.version === 6.9, "Project schema version must be 6.9.");
...
if (errors.length) {
  console.error("DAW 6.9 validation failed:");
  errors.forEach((error) => console.error(` - ${error}`));
  process.exit(1);
}

console.log("DAW 6.9 validation passed: draggable accessible rotary knobs, Shift fine adjustment, persistent realtime/offline master-volume slider, direct synth-track creation, multi-track management, 240 layered enterprise presets, and all DAW 6.7 piano-roll workflows.");
